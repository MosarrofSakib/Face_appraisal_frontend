    ...
    axios
      ...
      .catch((error) => {
        ...
        if (error.response) {
          ...
          setScore("An unknown error has occurred. Please try again!");
        }
      })
      .finally(() => {
        setLoading(false);
      ...
      <div className="flex flex-col h-screen p-4 max-w-lg">
        ...
        <div className="flex-grow place-content-center p-4">
          {screen == 1 && (
            <Upload
              imageSrc={imgSrc}
              onSelectImage={(src, img) => onSelectImage(src, img)}
            />
          )}
          {screen == 2 && (
            <Config
              ...
              onNormalizationTechniqueChange={setNormalizationTechnique}
        ...
        <div className="p-4 flex flex-row w-full">
          ...
          {screen != 3 && (
            <button
              className="btn btn-circle btn-primary"
              disabled={image == null || (screen == 2 && name == "")}
              onClick={() => onNextClick()}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
